...
//full name cases
//Tc3
import {validateEmailInput, validateFullNameInput, validatePassword2Input, validatePasswordInput} from "./validation";
...
it("Should Return False if password2 is empty and passwordl less than 8", () => {
  expect(validatePassword2Input("1234", "")).toBe(false);
});
...
//Email cases same as in sign in test cases
